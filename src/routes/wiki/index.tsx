    ...
    <WikiLayout>
      <div>
        ...
        <div class="card" style={{ "margin-top": "2rem", background: "rgba(59, 130, 246, 0.1)", border: "1px solid rgba(59, 130, 246, 0.3)" }}>
          ...
          <A href="/wiki/getting-started" class="button" style={{ display: "inline-block" }}>
        ...
        <div style={{ 
          ...
          <div class="card">
            ...
            <A href="/wiki/abilities" class="button secondary" style={{ display: "inline-block", "font-size": "0.9rem" }}>
              Browse Abilities
            </A>
          </div>
        ...
        <ul style={{ "line-height": "2" }}>
          ...
          <li><A href="/wiki/abilities">Abilities & Spells</A> - Complete ability database</li>
